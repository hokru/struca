...
write(iounit,*) ''
write(iounit,*) ' also distance between fitted planes'
write(iounit,*) ''
write(iounit,*) 'usage:'
write(iounit,*) 'Geometry centroid <file xyz> <int ring size> <index list of ring>'
write(iounit,*) 'Geometry plane <file xyz> <index list plane1> <index list plane2>'
write(iounit,*) ''
write(iounit,*) ''
